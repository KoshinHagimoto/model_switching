...
from change_detection_model.HH_package.hodgkinhuxley import HodgkinHuxley
...
class ParticleFilter(HodgkinHuxley):
    ...
    モデル選択を用いた変化点検出
    """
    def __init__(self, V_abnormal, n_particle=100, dt=0.05, C_m=1.0, g_Na=120.0, g_K=36.0, E_Na=50.0, E_K=-77.0, E_L=-54.387):
        self.V_abnormal = V_abnormal
